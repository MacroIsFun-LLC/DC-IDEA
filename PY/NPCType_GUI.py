...
class NPCTypeGUI(BaseGUI):
    def __init__(self, data_path=None):
        super().__init__(title="Register New NPC Type", width=400, height=280)
        ...
        # Name
        ctk.CTkLabel(self.main_frame, text="Type Name:", font=self.label_font).grid(row=0, column=0, padx=20, pady=20, sticky="w")
        ...
        self.btn_create = ctk.CTkButton(self.btn_frame, text="Define NPC Type", command=self.save_and_exit, 
